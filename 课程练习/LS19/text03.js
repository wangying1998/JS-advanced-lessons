...
console.log(Date.parse("2010-01-01 11:12:23.111")); // 转换成毫秒  1262315543111
console.log(new Date("2010-01-01 11:12:23.111")); // Fri Jan 01 2010 11:12:23 GMT+0800 (中国标准时间)
console.log(new Date().toISOString());

console.log(Date.parse("2010-01-01T11:12:23.111Z")); // 转换成毫秒  1262315543111
...
var today = new Date();
var new1 = new Date();
new1.setTime(today.getTime() + 50*24*60*60*1000);
new1.toLocaleDateString();
