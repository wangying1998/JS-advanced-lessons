...
var s1 = new Set([1,2,3,4,5,5,6,2,2]);  // 不重复
console.log(s1);
...
s.add(1).add(2).add(2);  // s.add()  返回的是对象
// 注意2被加入了两次
s.size // 2
s.has(1); // true
s.has(2); // true
...
console.log(typeof set.keys());// object  可用for...of遍历
console.log(typeof set.values());// object  可用for...of遍历
console.log(typeof set.entries());// object  可用for...of遍历
